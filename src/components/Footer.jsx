...
// const Footer = () => {
//     return (
//         <footer className="bg-white py-12 border-t border-white/10 text-white">
//             <div className="container mx-auto px-4 md:px-8">
//                 <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">

//                     {/* Column 1: Logo Replacement */}
//                     <div className="flex flex-col items-center md:items-start">
//                         <img
//                             src="/assests/bluelogo-removebg.png"
//                             alt="Brand Incept Logo"
//                             className="h-12 w-auto mb-4 object-contain"
//                             onError={(e) => { e.target.src = 'https://via.placeholder.com/150?text=Brand+Incept'; }}
//                         />
//                         <p className="text-[#017dc5] text-sm font-light">
...
//                         <h3 className="text-lg text-[#017dc5] font-semibold border-b-2 border-[#B21F24] pb-1 inline-block">
//                             Contact Info
//                         </h3>
//                         <div className="space-y-3 text-black">
//                             <p className="flex items-center gap-3">
//                                 <span className="text-[#B21F24]">📍</span>
...
//                             </p>
//                             <p className="flex items-center gap-3">
//                                 <span className="text-[#B21F24]">✉️</span>
//                                 <a href="mailto:jigar@brandincept.com" className="hover:text-white transition">
...
//                     {/* Column 3: Regional Coverage & Copyright */}
//                     <div className="flex flex-col items-center md:items-end space-y-4">
//                         <div className="text-center md:text-right">
//                             <p className="text-sm font-semibold text-[#017dc5] mb-2 uppercase tracking-widest">
//                                 Regional Experts
//                             </p>
//                             <p className="text-xs text-[#017dc5] italic">
//                                 Gujarat | Maharashtra | Rajasthan | Goa
//                             </p>
//                         </div>
//                         <div className="text-[#017dc5] text-xs pt-4 border-t border-white/5 w-full text-center md:text-right">
...
//                     <p className="text-black text-xs tracking-widest uppercase mb-2">
//                         Designed & Developed By
//                     </p>
//                     <p className="text-[#017dc5] font-medium tracking-wide">
